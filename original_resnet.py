...
from ori_model.resnet_cifar10_original import ResNet18,ResNet34,ResNet50,ResNet101,ResNet152

parser = argparse.ArgumentParser(description='PyTorch ImageNet Training')
parser.add_argument('--data', metavar='DIR',default='./',
                    help='path to dataset')
parser.add_argument('--save_dir', type=str, default='./record/original_resnet', help='Folder to save checkpoints and log.')
...
parser.add_argument('--n_gpus', type=int, default=[0,1], help='GPU numbers')
...
def main():
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        print("epoch:{} best accuracy: {:.4f}".format(epoch, best_prec1))
