...
parser.add_argument('--arch', metavar='ARCH', default='ResNet18', help='model architecture: (default: resnext29_8_64)')
...
def main():
    ...
    net = ResNet18(lr = args.lr,momentum=args.momentum, weight_decay=args.decay,criterion = criterion,n_gpus=args.ngpu)
    print_log("=> network :\n {}".format(net), log)
...
#     print(" accu after is: %s %%" % val_acc_2)
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        # adjust_learning_rate(net, epoch)
